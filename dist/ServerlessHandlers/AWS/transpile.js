...
var handler = function (event, context, callback) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 6, , 7]);
                return [4 /*yield*/, Promise.all(event.objects.map(preql_core_1.validateObject))];
            case 2:
                _a.sent();
                return [4 /*yield*/, preql_core_1.indexObjects(event.objects)];
            case 3:
                namespaces = _a.sent();
            ...
            case 6:
                e_1 = _a.sent();
                callback(normalizeError_1.default(e_1));
                return [3 /*break*/, 7];
